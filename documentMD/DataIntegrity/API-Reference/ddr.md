...
2. [!badge variant="warning" text="ddrRawId"] - [!badge variant="warning" text="string"]: Id offline was sent from Pharumo
...
3.[!badge variant="danger" text="ddrs"] - [!badge variant="danger" text="object"]: Ddrs has tokenId, ddrRawId and hashValue

 
#### Example

```ts
ddr.mintDDR("0x94f5115f6287e66e3fc9bbd6e4f621f7657efd488e304c810ce7d381b654f59f",
    "007",
    "13",
    "ggwp",
...
> {
  receipt: {
    ...
    logsBloom: '',
    logs: [ [Object], [Object], [Object], [Object], [Object], [Object] ],
    status: true,
    transactionHash: '0x83bf322c0d27e3cd6e94aa0bdf047564e2a65bea01d113db6724af9d3f10d313',
    transactionIndex: 0,
    blockHash: '0x1118c95adb3d657310f2bbb0630e934ba18ce54c4b5cd6f98d7e813607decec9',
    blockNumber: 1656748,
    gasUsed: 794016,
  ...
  ddrs: [
    {
      tokenId: '5',
      ddrRawId: '007',
      hashValue: '0x02ef0a921ec25ee3e7a884130a32b34d77d2de58c5a052f3b8bb49bea02672a9'
    }
  ]
}
```
...
```ts
 ddr.mintBatchDDR(["0x6a5d6c0fb2e1fcead919f640d7ecbd5785ba9caaf45461c38a15893771f0d1a1", "0x7b4402c4fb2ba988bbaec633d4c68eca466f96ba75ff358006e264168524890d"], 
        ["09", "08"],
        ["55", "66"],
        ["xxx", "yyy"],
        "0x7Aaf39BBD7Dd755EaA50F992522A4Eb3d8cd75a0",
...
> {
  receipt: {
    ...
    logsBloom: '',
    logs: [ [Object], [Object], [Object], [Object], [Object], [Object] ],
    status: true,
    transactionHash: '0x99e36320bebd87670cfcd692530ae9db6e7bc848d330846de927cdeae3dd296f',
    transactionIndex: 0,
    blockHash: '0xfae70507226decb837e385bdf92872ff68f1bf49d7b225fbc181b3ca617c4a9a',
    blockNumber: 1657481,
    gasUsed: 1504534,
    contractAddress: null,
    from: '0x51C4B0487e16186da402daebE06C4cD71b5015c8',
  ...
  ddrs: [
    {
      tokenId: '10',
      ddrRawId: '09',
      hashValue: '0x2fb8cc2fa1504ad1d348aa893604fe60a38f5d9ce0257ae2e34400600c4b12ae'
    },
    {
      tokenId: '11',
      ddrRawId: '08',
      hashValue: '0xa393f1efc2868f8134518c681b2f5e81314dfaeb7ad137ff4772191f56756a83'
    }
  ]
}
```
...
> {
  receipt: {
    ...
    logsBloom: '',
    logs: [
      [Object], [Object],
      [Object], [Object],
      [Object], [Object],
    ...
    status: true,
    transactionHash: '0xb1b19feca4952eb77dc82f6907423d4837b1e0f4f817fd6a690665fc3b106702',
    transactionIndex: 0,
    blockHash: '0x98950e23100786884b3bb3691aa6e56120c20878b2970c1dc2105518bfe93bc0',
    blockNumber: 1656770,
    gasUsed: 325253,
    contractAddress: null,
    from: '0x51C4B0487e16186da402daebE06C4cD71b5015c8',
...
1. [!badge variant="warning" text="ddrTokenIds"] - [!badge variant="warning" text="number"]: list ids token of ddr
2. [!badge variant="warning" text="patientDID"] - [!badge variant="warning" text="string"]: The address of patient
...
```ts
 ddr.disclosureConsentDDRFromProvider([0, 1],
        "0x7Aaf39BBD7Dd755EaA50F992522A4Eb3d8cd75a0",
...
> {
  receipt: {
    ...
    logsBloom: '',
    logs: [
      [Object], [Object],
      [Object], [Object],
      [Object], [Object],
    ...
    status: true,
    transactionHash: '0xd36bd4b080432a1fd6089a6b33e30897bc1cf095c9f95b328aaa246922bbba66',
    transactionIndex: 0,
    blockHash: '0xfb0e3be58d1964bcc935994ae22f126f5a6bb05a6a8479dbc4b22575014abd21',
    blockNumber: 1657328,
    gasUsed: 308787,
    contractAddress: null,
    from: '0x51C4B0487e16186da402daebE06C4cD71b5015c8',
...
```ts
ddr.getConsentedDDR(
  "0x37C819C94EdfE048968A28215C73C4D1B8ceAb15", 1)
  .then(console.log)
