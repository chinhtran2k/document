...
```ts
patient.mintPatient(patientDID, uri, privateKey);
```
... Patients
...
```ts
 patient.mintPatient("0x7Aaf39BBD7Dd755EaA50F992522A4Eb3d8cd75a0", 
            "gg", 
...
> {
  receipt: {
    ...
    logsBloom: '',
    logs: [ [Object], [Object] ],
    status: true,
    transactionHash: '0x1eee8a69ab89b1206dee736b1115feccee41bbe43c8bb5fc9a6f204c66ab6bf3',
    transactionIndex: 0,
    blockHash: '0x9375085f4e86a80aed5734ce96fbf0317a77230e8dc0c476b82f93b4a949d659',
    blockNumber: 1654534,
    gasUsed: 1210878,
...
```ts
patient.getPatientRootHashValue("0x7Aaf39BBD7Dd755EaA50F992522A4Eb3d8cd75a0").then(console.log)
