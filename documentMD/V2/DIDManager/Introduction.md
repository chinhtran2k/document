...
- [!badge variant="primary" text="ACCOUNT_TYPE"] - [!badge variant="primary" text="ACCOUNT_TYPE"] : Type of account DID
- [!badge variant="primary" text="ACCOUNT_ID"] - [!badge variant="primary" text="ACCOUNT_ID"]: ID of account
